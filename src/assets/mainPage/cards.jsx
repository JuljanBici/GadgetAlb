...
export default function Cards( {purchase, cart , liked , addLiked} ) {
  ...
  return (
    <div className=' my-14 '>
      <div className='flex flex-col text-[#323232] text-center'>
        <p className=' font-bold text-4xl mb-3'>PRODUKTE TE SAPOARDHURA</p>
        <p className=' font-medium text-2xl mb-14'>Bli online dhe perfito nga ofertat</p>
      </div>
            ...
            {cardsData.map((prod) => {
              ...
              <div className="mt-4 px-5 pb-5">
                ...
                <div className='w-full absolute bottom-0 right-0  flex py-3 px-3 border-t-[1.5px] items-center justify-center'>
                    <a onClick={addLiked(prod)} className='flex flex-col items-start px-3 py-[.63rem] mr-2 rounded-2xl min-w-10 bg-[#ede3da]  hover:invert duration-100 cursor-pointer'>
