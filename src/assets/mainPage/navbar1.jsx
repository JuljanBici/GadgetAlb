    ...
    <>
      <nav class="fixed z-50 top-0 w-full text-[#323232] bg-[#ceb39c] shadow pr-5 dark:bg-gray-900 dark:border-gray-700">
        <div class=" flex flex-wrap items-center justify-between mx-auto p-4">
          <Link onClick={refreshPage} to='/' class="flex items-center">
          ...
          <div id={isToggled ? "toggled" : ""} class="hidden z-50 w-full lg:block lg:w-auto" >
            <ul class="flex flex-col font-medium p-4 lg:p-0 mt-4 mr-6 border border-gray-300 rounded-lg bg-white bg-opacity-20 backdrop-blur-lg text-black lg:flex-row lg:text-[#323232] lg:space-x-8 lg:mt-0 lg:border-0 lg:bg-transparent ">
              ...
              <Link className='flex pl-2 rounded justify-start items-center hover:cursor-pointer hover:backdrop-blur-sm lg:hover:bg-transparent lg:border-0' onClick={refreshPage} to={!user ? '/login' : '/account'}>
              ...
              <Link className='flex pl-2 rounded justify-start items-center hover:cursor-pointer hover:backdrop-blur-sm lg:hover:bg-transparent lg:border-0'  onClick={refreshPage} to='/liked'>
