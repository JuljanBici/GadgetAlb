...
export default function Gaming( {purchase, cart , liked , addLiked} ) {
  ...
  return(
    <div className=' mb-14'>
      <img className=' object-cover w-full h-[390px] my-12 ' src={imgGaming} />
      <div className='flex flex-col text-center'>
        <p className=' font-bold text-4xl mb-3'>High-performance PCs for ultimate gaming experiences</p>
        <p className=' font-medium text-2xl mb-14'>Unleash gaming excellence with our powerful and immersive gaming PCs</p>
      </div>
