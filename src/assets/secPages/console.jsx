...
export default function Console( {purchase, cart , liked , addLiked} ) {
  ...
  return(
    <div>
      <img className=' object-cover w-full h-[390px] my-12 ' src={imgConsole} />
      <div className='flex flex-col text-center'>
        <p className=' font-bold text-4xl mb-3'>Immersive gaming consoles for thrilling adventures</p>
        <p className=' font-medium text-2xl mb-14'>Take gaming to the next level with our cutting-edge gaming consoles</p>
      </div>
