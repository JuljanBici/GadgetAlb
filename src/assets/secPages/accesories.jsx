...
export default function Accesories( {purchase, cart , liked , addLiked} ) {
  ...
  return(
    <div>
      <img className=' object-cover w-full h-[390px] my-10 ' src={imgAccesories} />
      <div className='flex flex-col text-center'>
        <p className=' font-bold text-4xl mb-3'>Premium accessories to enhance your tech setup</p>
        <p className=' font-medium text-2xl mb-14'>Enhance your tech experience with our premium range of accessories</p>
      </div>
