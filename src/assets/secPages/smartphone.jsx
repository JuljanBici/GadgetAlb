...
import imgPhone from '/Users/User/Desktop/tailwind-project/src/stockPhotos/smartphone.jpg'

export default function Smartphone( {purchase, cart , liked , addLiked} ) {
  ...
  return(
    <div className=' my-14'>
      <img className=' object-cover w-full h-[390px] mb-10 ' src={imgPhone} />
      <div className='flex flex-col text-center'>
        <p className=' font-bold text-4xl mb-3'>Cutting-edge smartphones for seamless connectivity</p>
        <p className=' font-medium text-2xl mb-14'>Stay connected and enjoy top-notch technology with our feature-packed smartphones</p>
      </div>
